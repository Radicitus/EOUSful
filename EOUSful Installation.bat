...
regedit.exe delete "HKEY_CURRENT_USER\Software\Microsoft\Windows\CurrentVersion\Explorer\Taskband"
...
regedit.exe import "C:\Users\confctr\Desktop\Taskbar.reg"
